...
def preorderTreversal(root):
    if root != ".":
        print(root, end="")
        preorderTreversal(tree[root][0])
        preorderTreversal(tree[root][1])

def inorderTreversal(root):
    if root != ".":
        inorderTreversal(tree[root][0])
        print(root, end="")
        inorderTreversal(tree[root][1])

def postorderTreversal(root):
    if root != ".":
        postorderTreversal(tree[root][0])
        postorderTreversal(tree[root][1])
        print(root, end="")
